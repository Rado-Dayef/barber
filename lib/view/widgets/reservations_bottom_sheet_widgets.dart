...
List<Widget> ReservationsBottomSheetWidgets(
  ...
  return [
    Text(
      ...
      style: AppFonts.fontHeavy20Petrol.copyWith(color: AppColors.white),
    ),
    GapWidget(15),
    ...
    Container(
      ...
      child: Column(
        ...
        children: [
          ...
          GapWidget(10),
          Text(barberName, style: AppFonts.fontHeavy25White),
          Text(
            date,
            style: AppFonts.fontHeavy16White.copyWith(fontSize: 14.sp),
          ),
        ],
      ),
    ),
